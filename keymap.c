...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_UTILITY] = LAYOUT( //8
      //,-----------------------------------------------------.                    ,-----------------------------------------------------.
           ALTTAB, CS_VALU, XXXXXXX, CS_VOLU, XXXXXXX, KC_SCRL,                       KC_NUM,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_DEL,
      //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
          KC_LSFT, CS_VALD, KC_MPRV, CS_VOLD, KC_MNXT, KC_CAPS,                        TG(9),   KC_F4,   KC_F5,   KC_F6,  KC_F11,  KC_TAB,
      //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
          KC_LCTL,  QK_RBT, QK_BOOT,    MUTE, CS_RGBN, CS_RGBT,                      XXXXXXX,   KC_F1,   KC_F2,   KC_F3,  KC_F12,  KC_ENT,
      //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
